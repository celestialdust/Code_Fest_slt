...
def test(
    ...
    if output_path is not None:
        ...
        beam_search_hyper_parameters = {"dev_best_translation_beam_size": dev_best_translation_beam_size,
                                  "dev_best_translation_alpha": dev_best_translation_alpha}

        with open(os.path.join(output_path, "beam_search_hyper_parameters.pkl"), "wb") as out:
            pickle.dump(
                beam_search_hyper_parameters,
                out,
            )
