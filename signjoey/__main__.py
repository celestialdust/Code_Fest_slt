...
from signjoey.translation import translate
...
def main():
    ...
    ap.add_argument("mode", choices=["train", "test", "translate"], help="train a model or test or translate the sign language")
    ...
    if args.mode == "train":
        ...
        translate(cfg_file=args.config_path, ckpt=args.ckpt, output_path=args.output_path)
    else:
